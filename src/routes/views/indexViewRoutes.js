...
import { getAllTareas } from '../../controllers/tareaController.js';
...
////
////
import Tarea from '../../models/Tarea.js'; // Asegurate de tener este modelo si no estás usando el controlador directamente
...
router.get('/admin/dashboard', protect, authorize(['admin']), async (req, res) => {
  try {
    ...
    const tareas = await Tarea.find().lean(); // o getAllTareas() si querés usar el controlador
